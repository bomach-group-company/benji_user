...
class CheckoutDraftScreen extends StatefulWidget {
  final Order order;
  final Address deliverTo;

  const CheckoutDraftScreen({
    super.key,
    required this.order,
  ...
  @override
  State<CheckoutDraftScreen> createState() => _CheckoutDraftScreenState();
}

class _CheckoutDraftScreenState extends State<CheckoutDraftScreen> {
  //=================================== INITIAL STATE ==========================================\\
  @override
  void initState() {
    super.initState();
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return SizedBox(
                                width: media.width,
                                child: Text(
                                  '${widget.order.orderitems[index].quantity}x  ${widget.order.orderitems[index].product.name}',
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                    color: kTextGreyColor,
