                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) => MyCard(
                                  ...
                                  navigateCategory: CategoryPage(
                                    activeSubCategory:
                                        trendingProduct[index].subCategoryId,
                            ...
                            children: [
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) => MyCard(
                                  ...
                                  navigate:
                                      ProductPage(product: todayProduct[index]),
                                  action: () {
                                    showMyDialog(context, todayProduct[index]);
                                  },
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) => MyCard(
                                  ...
                                  navigateCategory: CategoryPage(
                                    activeSubCategory:
                                        recommendedProduct[index].subCategoryId,
                                    activeCategory: recommendedProduct[index]
                                        .subCategoryId
                                        .category,
                                  ),
                                  navigate: ProductPage(
