            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (!snapshot.hasData) {
                if (snapshot.hasError) {
                  return const Center(
                    child:
                        Text('Error occured try refresh or contacting admin'),
                  );
                }
                return Center(
                ...
                return Stack(
                  children: [
                                ...
                                child: CarouselSlider(
                                  options: CarouselOptions(
                                    ...
                                    height: MediaQuery.of(context).size.width *
                                        breakPoint(
                                            media.width, 0.3, 0.22, 0.16),
                                    viewportFraction: breakPoint(
                                        media.width, 0.5, 0.5, 0.3333),
                                    padEnds: false,
                                  ),
                                  items: const [
                                    MyImageCard(
                              ...
                              Container(
                                ...
                                child: CarouselSlider(
                                  options: CarouselOptions(
                                    ...
                                    height: MediaQuery.of(context).size.width *
                                        breakPoint(
                                            media.width, 0.5, 0.44, 0.24),
                                    viewportFraction: breakPoint(
                                        media.width, 0.5, 0.5, 1 / 4),
                                    padEnds: false,
                                  ),
                                  items: const [
                                    MyImageCard(
                    ...
                    Builder(builder: (context) {
                      Product data = (snapshot.data['productsData']
                              as AllProduct)
                          .items
                          .firstWhere(
